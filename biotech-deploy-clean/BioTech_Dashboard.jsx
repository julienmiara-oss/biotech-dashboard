...
import { Building2, Users, FlaskConical, Wallet, TrendingUp, TrendingDown, Settings, Plus, Trash2, Check, X, DollarSign, Euro, Calendar, AlertTriangle, ChevronDown, ChevronRight, Edit3, ArrowUpRight, Cloud, CloudOff, Loader2, Upload, FileSpreadsheet, Download, Copy, Eye, EyeOff } from "lucide-react";
        ...
        {showAdd && (
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
            ...
            <div className="space-y-3">
              ...
              <textarea placeholder="Notes" onChange={v => setEditForm({...editForm, notes: v})} value={editForm.notes || ""} className="w-full h-16 border rounded-lg p-2 text-sm" />
              <div className="flex gap-2">
